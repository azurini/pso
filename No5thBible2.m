...
for i=1:N                                 %读者 从高处走来 去寻找查拉图斯特拉的灵魂
    p(i)=fitness2(x(i,:),D);              %这时他在林中遇到一位老者，老者说 “上帝已死，没有道德和真理，没有人可以成为至人”
    y(i,:)=x(i,:);                        %读者 叹息道“可惜老者并不知道，我所追寻的并非是已死上帝的真理 我将要旅途中创造的是我自己啊”
end                                       %便坚定的继续向前走去

pg=x(1,:);                                %读者 告诉路边的尼采 尽管没有人可以成为上帝那样的人，但是我可以把我的经验告诉你，你负责记录每一个读者的人生 最终一定能复原至人的灵魂。
